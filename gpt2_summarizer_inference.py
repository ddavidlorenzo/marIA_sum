...
if __name__ == '__main__':
    ...
    parser.add_argument("--model", default='base', choices=["base", "large"], help="type of gpt2 model")
    parser.add_argument("--batch_size",default=1, type=int, required=True, help="batch_size")
    parser.add_argument("--num_train_epochs",default=3, type=int, required=True, help="no of epochs of training")
    ...
    parser.add_argument("--num_workers",default=1, type=int, required=False, help="num of cpus available")
